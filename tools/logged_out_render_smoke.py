...
DEFAULT_ENDPOINTS = (
    ...
    ExpectedEndpoint("/api/targets/shakira/restore", 401, "viewer_login_required", method="POST", body={}),
    ExpectedEndpoint("/api/categories", 401, "viewer_login_required", method="POST", body={"name": "Smoke Category"}),
    ExpectedEndpoint(
        "/api/classifications",
        401,
        "viewer_login_required",
