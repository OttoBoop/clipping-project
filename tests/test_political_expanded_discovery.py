...
def test_all_38_active_inventory_products_and_audited_nationals_have_scoped_routes():
    ...
    assert all(r['allowed_profiles'] == ['psd_rj_2026'] and r['google_policy'] == ('never' if r['key'] in {'istoe', 'congresso_em_foco', 'estadao', 'exame'} else 'on_direct_gap') for r in rows)
