...
@pytest.mark.parametrize('text,expected',[
 ...
 ('O perfil Daily do Garotinho publicou o flagra de uma festa no Rio.',set()),
 ('O perfil Daily do Garotinho falou do governo do Rio.',set()),
 ('Garotinho publicou fotos da festa em Campos e no Rio.',set()),
 ('O chope garotinho sai por R$ 9 no Rio de Janeiro.',set()),
 ('Justiça do Rio pede inelegibilidade de Garotinho.',{'anthony_garotinho'}),
 ('Justiça suspende direitos políticos de Garotinho por oito anos.',{'anthony_garotinho'}),
