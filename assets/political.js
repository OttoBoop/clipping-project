(() => {
  ...
  async function openArticle(article) {
    ...
    if (body.status === "fulfilled" && body.value.contentFormat === "web_story") $("article-message").append(text("p", "Texto dos slides da publicação, preservado na ordem de leitura."));
